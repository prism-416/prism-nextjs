...
export function AuthStepIndicator({ steps, currentStepIndex, tone = "light" }: AuthStepIndicatorProps) {
  return (
    <nav aria-label="Sign up progress" className="space-y-3">
      <div
        className={cn(
          "flex items-center justify-between text-[0.7rem] font-semibold uppercase tracking-[0.28em]",
          tone === "dark" ? "text-[#f4ecd6]/82" : "text-prism-body/48",
        )}
      >
                  ...
                  tone === "dark" &&
                    (isActive
                      ...
                      : isComplete
                        ...
                        : "bg-white/18"),
                  tone === "light" &&
                    (isActive || isComplete ? "bg-primary" : "bg-prism-sand/80"),
                )}
              />
              <div className="space-y-0.5">
                <p
                  className={cn(
                    ...
                    tone === "dark" ? "text-[#f4ecd6]/62" : "text-prism-body/42",
                  )}
                >
                  {step.step}
                </p>
                <p
                  className={cn(
                    ...
                    tone === "dark" &&
                      (isActive ? "font-semibold text-white" : isComplete ? "font-medium text-white/84" : "font-medium text-white/60"),
