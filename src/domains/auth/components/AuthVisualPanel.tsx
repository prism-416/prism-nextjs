      ...
      <div className="relative flex h-full flex-col justify-between px-12 py-14 text-white">
        <div className="max-w-2xl space-y-8">
          <div className="space-y-4">
            <p className="text-xs font-semibold uppercase tracking-[0.32em] text-[#f4ecd6]/70">Prizmatic Workspace</p>
            <div className="space-y-4">
        ...
        <div className="max-w-xl border-t border-white/12 pt-8">
          <p className="text-sm font-medium uppercase tracking-[0.22em] text-[#f4ecd6]/72">Designed for teams</p>
