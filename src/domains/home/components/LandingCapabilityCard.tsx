...
export default function LandingCapabilityCard({
  ...
  return (
    <article className="group relative overflow-hidden rounded-[1.75rem] border border-border bg-[linear-gradient(180deg,rgba(255,255,255,0.95),rgba(236,245,243,0.72))] p-7 shadow-sm transition duration-200 hover:-translate-y-1 hover:border-prism-teal-500/60 hover:shadow-xl hover:shadow-prism-teal-500/10">
