...
export function WorkspaceJobsClient({ workspace, initialData, canManageJobs }: WorkspaceJobsClientProps) {
  ...
  const canSubmit = canManageJobs && hasChanges && !hasErrors(draftErrors) && !saveJobs.isPending;
  ...
  async function handleSave() {
    ...
    try {
      ...
      setDraftErrors({});
      setActionMessage("Workspace jobs saved.");
      setIsDirty(false);
    } catch {
      setActionMessage("Workspace jobs could not be saved.");
    }
  }
        ...
        {canManageJobs ? (
          <div className="flex flex-wrap gap-2">
            ...
            <Button
              ...
              disabled={!isDirty || saveJobs.isPending}
            >
                ...
                <div className="grid gap-2 md:grid-cols-[minmax(10rem,14rem)_minmax(0,1fr)_6.5rem] md:items-center md:gap-3">
                  <div className="min-w-0 space-y-1.5 md:space-y-0">
                    ...
                    <Input
                      ...
                      disabled={!canManageJobs || saveJobs.isPending}
