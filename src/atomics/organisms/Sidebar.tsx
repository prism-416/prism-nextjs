...
import { Separator } from "@/atomics/atoms/Separator";
import { Sheet, SheetContent, SheetDescription, SheetHeader, SheetTitle } from "@/atomics/atoms/Sheet";
...
>(({ side = "left", variant = "sidebar", collapsible = "offcanvas", className, children, ...props }, ref) => {
    ...
    return (
      ...
      >
        <SheetContent
          ...
          data-mobile="true"
          className="w-[var(--sidebar-width)] bg-surface-strong p-0 text-sidebar-foreground [&>button]:hidden"
          style={
            {
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "fixed top-[var(--header-height,0px)] bottom-0 z-10 hidden h-[calc(100svh-var(--header-height,0px))] w-[var(--sidebar-width)] transition-[left,right,width] duration-200 ease-linear md:flex",
          side === "left"
